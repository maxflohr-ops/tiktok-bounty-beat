...
const SECTIONS: LegalSection[] = [
    ...
    body: (
      <>
        <p>
          ...
          creating an account, posting a bounty, or claiming one, you agree to these terms and to our
    ...
    body: (
      <>
        ...
        <p>
          ...
          venturer. Clippers are independent contractors and decide for themselves whether, when, and
    ...
    body: (
      <>
        <p>
          ...
          (or the age of majority where you live) to claim a bounty, deliver a clip for payment, post
          a purse, or receive a payout. If you use the service on behalf of a company, you confirm
        ...
        <p>
          ...
          than their share of a purse or to evade a claim cap. Tell us promptly at {MAIL(LEGAL_EMAIL)}{" "}
      ...
      <>
        ...
        <ul>
          <li>
            ...
            before the bounty&rsquo;s deadline. Claims and first deliveries are not accepted after it
            passes.
          </li>
          <li>
          ...
          <li>
            ...
            figure we verify, not the figure displayed to you. Where a bounty pays per 100,000 views,
            payment is pro rata to the view, and views may stack across your clips on that bounty.
          </li>
          <li>
            <strong className="text-bone">Purse limits.</strong> A purse is finite. Once it is
            exhausted, no further payouts are made from that bounty, even for eligible views. Where a
            bounty sets a cap on claims or clips per editor, that cap is binding.
          </li>
          <li>
            <strong className="text-bone">Campaign rules.</strong> Requirements printed on a bounty —
            a required sound, hashtag, aspect ratio, or logo overlay — are conditions of payment. A
            clip that ignores them may be rejected.
          </li>
          <li>
        ...
        <p>
          We review delivered clips and may approve or reject them. Rejection reasons are recorded on
          the submission. Deleting, hiding, or making a clip private before it is paid ends its
          eligibility.
        </p>
      </>
    ),
    ...
    body: (
      <>
        ...
        <p>
          ...
          including the right to have it distributed on the relevant social platform — and that doing
          so infringes no third party&rsquo;s rights. You will indemnify Bounty Sounds and
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li>
            use bots, automation, click farms, view exchanges, incentivised traffic, or paid services
            that generate views, likes, follows, or comments;
          </li>
          <li>
          ...
          <li>
            re-upload another editor&rsquo;s clip, or submit the same clip to a bounty more than once
    ...
    body: (
      <>
        <p>
          ...
          sponsored by, or in partnership with TikTok, ByteDance, YouTube, Google, Meta, or any other
          platform. Platform names and marks are the property of their owners and are used only to
          describe where clips are posted.
        </p>
        <p>
          ...
          for complying with them, including labelling commercial content where the platform requires
          it. Nothing in these terms overrides a platform&rsquo;s rules; where they conflict, the
          platform&rsquo;s rules govern what you may post there.
        </p>
        <p>
    ...
    body: (
      <>
        <p>
          ...
          responsible for the accuracy of your payout details; we are not liable for funds sent to an
          address you supplied incorrectly. Payment processors may apply their own fees, timings, and
          country restrictions.
        </p>
        <p>
          Clippers are independent contractors and are solely responsible for their own taxes. Once
          your lifetime earnings reach US$150, you must provide the tax information we request before
          further payouts are released, and we may report payments to tax authorities as law
          requires.
        </p>
        <p>
    ...
    body: (
      <>
        <p>
          ...
          clips you create. By submitting a clip to a bounty, you grant Bounty Sounds a non-exclusive,
          worldwide, royalty-free licence to display the clip&rsquo;s public URL, thumbnail, handle,
          and performance figures on the board, on that bounty&rsquo;s page, in our public campaign
          feed, and in ordinary promotion of the service. You also grant the poster of that bounty the
          licence stated on the bounty for use of the clip in connection with the campaign.
        </p>
        <p>
          <strong className="text-bone">Campaign material stays the poster&rsquo;s.</strong> Sounds,
          footage, artwork, and logo packs supplied for a campaign are licensed to you only for making
          and posting clips for that bounty, and that licence ends if your submission is rejected or
          the campaign closes.
        </p>
        <p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li>break the law, or infringe anyone&rsquo;s intellectual property, privacy, or publicity rights;</li>
          <li>post content that is hateful, harassing, sexually explicit, or that endangers minors;</li>
          ...
          <li>scrape, probe, overload, or reverse engineer the service, or bypass its rate limits or access controls;</li>
          <li>resell or sublicense access to the board, or create derivative marketplaces from our data without written permission.</li>
        </ul>
        <p>
    ...
    body: (
      <>
        <p>
          ...
          users or to the service. Where the law allows and it is safe to do so, we will tell you why.
        </p>
        <p>
    ...
    body: (
      <>
        ...
        <p>
          ...
          attract, the rate and purse on the bounty, and the purse remaining. We do not guarantee that
          any bounty will be claimed, that any clip will be approved, or that a platform will keep a
          clip online or report metrics accurately.
        </p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>
          To the fullest extent permitted by law, Bounty Sounds and {OPERATOR} will not be liable for
        ...
        <p>
          Our total liability for all claims relating to the service in any 12-month period is limited
          to the greater of the amounts you paid to or earned through Bounty Sounds in that period, or
          US$100. Some jurisdictions do not allow these limits, in which case they apply to the
    ...
    body: (
      <>
        <p>
          ...
          top of this page and, for material changes, give notice by email or a prominent site notice
          before they take effect. Continuing to use Bounty Sounds after that means you accept the
          updated terms. Terms applying to a bounty you already claimed remain as published when you
          claimed it.
        </p>
        <p>
          If any provision is held unenforceable, the rest remains in force. Our failure to enforce a
          provision is not a waiver of it. You may not assign these terms without our consent; we may
          assign them in connection with a merger, acquisition, or sale of assets. These terms and the
