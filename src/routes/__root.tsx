...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bounty Sounds — clipping bounties on sounds, streams & keynotes" },
      {
        name: "description",
        content:
          "Bounty Sounds is a pay-per-view clipping board. Artists, streamers, and speakers fund bounties; clippers post TikToks and get paid per verified view.",
      },
      ...
      { name: "twitter:image", content: "https://bountysounds.com/og.png" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=DM+Sans:ital,wght@0,400;0,500;0,700;1,400&family=Permanent+Marker&family=Inter:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap",
      },
