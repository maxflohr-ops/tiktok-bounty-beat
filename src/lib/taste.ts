...
export const GENRES = [
  {
    id: "hiphop",
    label: "Hip-hop / rap",
    words: ["rap", "hip hop", "hip-hop", "trap", "drill", "freestyle"],
  },
  {
    id: "electronic",
    label: "Electronic / EDM",
    words: ["edm", "house", "techno", "electronic", "dnb", "drum and bass", "dubstep", "rave"],
  },
  {
    id: "phonk",
    label: "Phonk / underground",
    words: ["phonk", "underground", "memphis", "drift"],
  },
  ...
  { id: "rnb", label: "R&B / soul", words: ["r&b", "rnb", "soul", "slow jam", "vocals"] },
  {
    id: "indie",
    label: "Indie / alt",
    words: ["indie", "alt", "alternative", "bedroom", "lo-fi", "lofi"],
  },
  { id: "rock", label: "Rock / metal", words: ["rock", "metal", "punk", "guitar", "riff"] },
  {
    id: "latin",
    label: "Latin / afro",
    words: ["latin", "reggaeton", "afro", "afrobeat", "amapiano", "dembow"],
  },
] as const;
...
export const VIBES = [
  {
    id: "high_energy",
    label: "High energy",
    words: ["hype", "energy", "hard", "fast", "gym", "workout", "sports"],
  },
  {
    id: "chill",
    label: "Chill / ambient",
    words: ["chill", "ambient", "calm", "smooth", "vibe", "aesthetic", "study"],
  },
  {
    id: "dark",
    label: "Dark / moody",
    words: ["dark", "moody", "night", "haunting", "eerie", "cinematic"],
  },
  {
    id: "feel_good",
    label: "Feel-good / fun",
    words: ["fun", "feel good", "feel-good", "happy", "summer", "dance", "meme", "comedy"],
  },
] as const;
